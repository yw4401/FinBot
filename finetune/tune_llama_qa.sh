...
deepspeed tune_qa.py --deepspeed=deepspeed_llama2.json --output_dir="./qa-llama-lora" \
 --per_device_train_batch_size=2 --learning_rate=1e-4 --num_train_epochs=1 --weight_decay=0.1 --warmup_steps=200 \
